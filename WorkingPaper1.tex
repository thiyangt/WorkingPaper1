...
to Experiment 1 and Figure \ref{fig:exp2} to Experiment 2. The points on
each plot represent individual time series. In each fogure the top row
of plots refers to the yearly data, the middle row to the quarterly data
and the bottom row to the monthly data. The plots show that the first
three principle components explain 62.5\%, 62.4\% and 58.93\% of the
total variation in the yearly, quarterly and monthly M1 data and 62.2\%
...
\caption{ Correlation matrix plots for the reference sets. A: Experiment 1 yearly, B: Experiment 2 yearly, C: Experiment 1 quarterly, D: Experiment 2 quarterly, E: Experiment 1 monthly, F: Experiment 2 monthly.}\label{fig:cormatplots}
\end{figure}
