...
# Application to the M competition data {#Mcomp}
...
The candidate models we consider as class labels for the annual series are:
  ...
  (a) AR/MA/ARMA
  (a) ARIMA;
  (a) Random walk with drift (RWD);
  (a) Random walk (RW);
  (a) Theta;
  (a) Exponential Smoothing Model (ETS) without trend and seasonal components;
  (a) ETS with trend component and without seasonal component;
  (a) ETS with damped trend component and without seasonal component;
...
# the relevant codes are available at: src/main.R
